...
const updateUser = asyncHandler(async (req, res) => {
    ...
    if (user) {
      ...
      // there was a bug when I didn't check if isAdmin === true
      // I tried to change the name of steve smith to stevesteve smith
      // but I got User validation failed: isAdmin: Path `isAdmin` is required in postman
